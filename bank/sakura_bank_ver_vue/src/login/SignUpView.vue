...
async function onSubmit() {
  ...
  if (!trimmedUserId || !trimmedPassword || !confirmPassword.value.trim()) {
    ...
    >
      ...
      >
        <div class="mx-auto flex max-w-md flex-col gap-6">
          ...
          <button
            type="button"
            class="inline-flex items-center justify-center gap-2 text-sm font-medium text-primary underline-offset-4 transition hover:underline"
